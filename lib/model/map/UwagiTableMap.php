...
/**
 * This class defines the structure of the 'uwagi' table.
 *
 *
 ...
 */
class UwagiTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.UwagiTableMap';
	...
	public function initialize()
	{
	  // attributes
		$this->setName('uwagi');
		$this->setPhpName('Uwagi');
		$this->setClassname('Uwagi');
